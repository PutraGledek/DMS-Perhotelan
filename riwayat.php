...
$page_title = "Riwayat & Laporan - NusaDMS";
            ...
            <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
                ...
                <form method="GET" action="riwayat.php" class="flex flex-wrap gap-4 mb-6 pb-6 border-b border-gray-100">
                    ...
                    <div class="w-full md:w-auto flex items-end gap-2">
                        <button type="submit" class="flex-1 md:flex-none px-6 py-2 bg-primary text-white font-bold rounded-lg hover:bg-primary-hover transition-all text-sm h-[38px]">
                            Filter
                        </button>
                        <a href="riwayat.php" class="flex-1 md:flex-none px-4 py-2 bg-gray-200 text-gray-700 font-bold rounded-lg hover:bg-gray-300 transition-all text-sm h-[38px] flex items-center justify-center">
                            Reset
                        </a>
                    </div>
                </form>
                                ...
                                <?php foreach ($history as $row): ?>
                                    <tr class="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                                        ...
                                        <td class="p-4 text-right">
                                            <a href="detail-track.php?id=<?= $row['id_laporan'] ?>" class="text-gray-400 hover:text-primary transition-colors" title="View Detail">
